...
000000e0 <__crt0_clear_bss_loop_end>:
  ...
  e4:	0fc58593          	addi	a1,a1,252 # 1dc <__crt0_copy_data_src_begin>
...
00000184 <main>:
 ...
 19c:	00900913          	li	s2,9
 1a0:	004c54b7          	lui	s1,0x4c5
 1a4:	00040513          	mv	a0,s0
 1a8:	00140413          	addi	s0,s0,1
 1ac:	0ff47413          	andi	s0,s0,255
 1b0:	01c000ef          	jal	ra,1cc <iceduino_sevensegment_set>
 1b4:	00897463          	bgeu	s2,s0,1bc <main+0x38>
 1b8:	00000413          	li	s0,0
 1bc:	b4048793          	addi	a5,s1,-1216 # 4c4b40 <__crt0_copy_data_src_begin+0x4c4964>
 1c0:	fff78793          	addi	a5,a5,-1
 1c4:	fe079ee3          	bnez	a5,1c0 <main+0x3c>
 1c8:	fddff06f          	j	1a4 <main+0x20>

000001cc <iceduino_sevensegment_set>:
 1cc:	0ff57513          	andi	a0,a0,255
 1d0:	f00007b7          	lui	a5,0xf0000
 1d4:	08a78023          	sb	a0,128(a5) # f0000080 <__ctr0_io_space_begin+0xf0000280>
 1d8:	00008067          	ret
