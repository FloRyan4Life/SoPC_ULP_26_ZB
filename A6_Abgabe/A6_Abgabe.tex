\newpage
\section{Seven Segment Ansteuerung}


Grundsätzlicher Aufbau
main -> seven segment library -> Speichervariable schreiben
-> VHDL Modul liest über wishbone bus die Speichervariable 
-> VHDL Modul übersetzt die Daten auf die Ausgabe und schreibt
Pins (pcf zuordnung)
...
2. Library Dateien zeigen und erklären

\begin{minted}{c}
#ifndef ICEDUINO_SEVENSEGMENT_H
#define ICEDUINO_SEVENSEGMENT_H
...
Dieser Teil wurde in neorv32_iceduino.h hinzugefügt um die Speicheradresse der SevenSegment-Datenvariable festzulegen. 


4. pcf Datei zeigen und erklären



5. Simulation zeigen mit Screenshots



6. Bild der Umsetzung an realer Hardware (Verdrahtung und voller Aufbau)
