...
//SWITCH base address
#define ICEDUINO_SWITCH_BASE (0xF0000008UL) 
//SWITCH input port 8-bit (r) */
#define ICEDUINO_SWITCH (*((const volatile uint8_t*) (ICEDUINO_SWITCH_BASE)))

//BUTTON base address
#define ICEDUINO_BUTTON_BASE (0xF0000010UL) 
//BUTTON input port 8-bit (r) */
#define ICEDUINO_BUTTON (*((const volatile uint8_t*) (ICEDUINO_BUTTON_BASE)))

//PMOD1 address
#define ICEDUINO_PMOD1_BASE (0xF0000018UL)
//PMOD1 output port 8-bit (r/w) */
#define ICEDUINO_PMOD1_OUTPUT (*((volatile uint8_t*) (ICEDUINO_PMOD1_BASE)))
//PMOD1 input port 8-bit (r) */
#define ICEDUINO_PMOD1_INPUT (*((const volatile uint8_t*) (ICEDUINO_PMOD1_BASE + 8)))

//PMOD2 address
#define ICEDUINO_PMOD2_BASE (0xF0000028UL)
//PMOD2 output port 8-bit (r/w) */
#define ICEDUINO_PMOD2_OUTPUT (*((volatile uint8_t*) (ICEDUINO_PMOD2_BASE)))
//PMOD2 input port 8-bit (r) */
#define ICEDUINO_PMOD2_INPUT (*((const volatile uint8_t*) (ICEDUINO_PMOD2_BASE + 8)))

//PMOD3 address
#define ICEDUINO_PMOD3_BASE (0xF0000038UL)
//PMOD3 output port 8-bit (r/w) */
#define ICEDUINO_PMOD3_OUTPUT (*((volatile uint8_t*) (ICEDUINO_PMOD3_BASE)))
//PMOD3 input port 8-bit (r) */
#define ICEDUINO_PMOD3_INPUT (*((const volatile uint8_t*) (ICEDUINO_PMOD3_BASE + 8)))
