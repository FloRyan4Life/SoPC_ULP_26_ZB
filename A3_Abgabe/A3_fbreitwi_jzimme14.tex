\section{Addressierungsbeispiel}
...
\newpage
\subsection{Addr\_Slave Testbench}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=\textwidth]{sim_addrslave.png}
...
\newpage
\subsection{Master Architektur und Code}

\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{system_overview.jpeg}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[scale=0.1, angle=90]{state_maschine.jpeg}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=\textwidth, angle=0]{sim1.png}
  \caption{Simulation des Address-Master mit Slave}
  \label{fig:master-sim}
\end{figure}
